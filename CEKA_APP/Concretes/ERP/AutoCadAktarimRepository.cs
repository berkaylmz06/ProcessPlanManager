...
//                System.Diagnostics.Debug.WriteLine($"KontrolAdeta Sorgusu: kalite={kalite}, malzemeAd={malzeme}, malzemeKod={kalip}, projeAdi={proje}, malzemeKodLike={command.Parameters["@malzemeKodLike"].Value}");
