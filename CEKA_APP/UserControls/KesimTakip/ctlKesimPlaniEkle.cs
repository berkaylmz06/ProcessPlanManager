                ...
                using (var scope = new TransactionScope())
                {
                    ...
                    foreach (var oranKvp in anaPozToplamOran)
                    {
                        ...
                        if (anaPozBilgileri.ContainsKey(anaPozKey))
                        {
                            ...
                            decimal hesaplananAdet = netAgirlik > 0 ? hesaplananAgirlik / netAgirlik : 0;
                            ...
                            {
                                hataMesajlari.Add(
                                    $"EK Hesaplama Hatası (EK'li Poz): [{detayIfsKalite} - {detayIfsMalzeme} - {kalip} - {basePoz} - {detayProje}]\n" +
                    ...
                    foreach (var entry in kalipPozProjeToplamAdet)
                    {
                        ...
                        {
                            hataMesajlari.Add(
                                $"Stok Yetersizliği (EK'siz Poz): [{kalite} - {malzeme} - {kalip} - {poz} - {proje}]\n" +
