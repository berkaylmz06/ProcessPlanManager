    ...
    public partial class ctlProjeKutuk : UserControl
    {
        ...
        public ctlProjeKutuk(IServiceProvider serviceProvider)
        {
                ...
                if (parentForm.projeBilgileri == null)
                {
                    ...
                    if (!projeBilgileriEventAttached)
                    {
                        parentForm.projeBilgileri.OnKaydet += () =>
                        {
                            ...
                            btnKaydet.PerformClick(); // btnKaydet butonunu tetikle
                        };
                        projeBilgileriEventAttached = true; // Duplicate abonelik önleme
                    }
                }
            ...
            mnuProjeFiyatlandirma.Click += (s, e) =>
            {
                ...
                // Düzeltme: Null kontrolü ve instantiate (önceki gibi)
                ...
                // Düzeltme: Event binding - Null kontrolü YERİNE flag kullan
                if (!_fiyatlandirmaEventAttached)
                {
                    ...
                    _fiyatlandirmaEventAttached = true;  // Flag'i true yap, duplicate önle
                }

                // Geri kalan kod: Alt proje varsa dialog aç, yoksa doğrudan yükle
        ...
        private void UpdateContextMenu()
        {
            ...
            {
                mnuProjeBilgileri.Enabled = true; 
                mnuProjeFiyatlandirma.Enabled = false;  // ✅ Proje ID yoksa pasif
            }
        }
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (isProjeKayitli)
            {
                ...
                if (!degisiklikVar)
                {
                    bildirimMesajlari.Add("Herhangi bir değişiklik yapılmadı.");
